...
signal animatronic_route_changed(animatronic_name: String, scenario_name: String, route_index: int)
signal power_out
...
signal player_response_profile_updated(avg_response_time: float)
